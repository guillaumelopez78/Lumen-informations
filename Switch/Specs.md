...
## Tokens Used in Switch

| Property | Token | Value |
|----------|-------|-------|
| Height (compact) | `--lumen-sizing-32` | 32px |
| Height (default) | `--lumen-sizing-44` | 44px |
| Width | `--lumen-sizing-64` / `--lumen-sizing-48` | 64px (default), 48px (compact) |
| Border radius | `--lumen-border-radius-full` | 9999px |
| Transition | `--lumen-motion-standard` | 200ms ease |
| Background (on) | `--lumen-color-accent` | #0066FF |
| Background (off) | `--lumen-color-border-neutral` | #D0D0D0 |
| Thumb (on) | `--lumen-color-surface-primary` | #FFFFFF |
