...
## Tokens Used in Checkbox

| Property | Token | Value |
|----------|-------|-------|
| Size | `--lumen-sizing-20` / `--lumen-sizing-24` | 20px (sm), 24px (md) |
| Border radius | `--lumen-border-radius-xs` | 2px |
| Border width | `--lumen-border-width-xs` | 1px |
| Border color | `--lumen-color-border-neutral` | #D0D0D0 |
| Background (checked) | `--lumen-color-accent` | #0066FF |
| Background (unchecked) | `--lumen-color-surface-primary` | #FFFFFF |
| Label font size | `--lumen-font-size-body-md` | 14px |
| Label color | `--lumen-color-text-primary` | #000000 |
| Focus ring | `--lumen-color-border-focus` | #000000 |
| Focus ring width | `--lumen-border-width-lg` | 2px |
| Disabled opacity | `--lumen-opacity-disabled` | 0.5 |
